...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics,comet):
...
def main():
    ...
    parser.add_argument('--comet', help='Enable comet or not', default=False, metavar='BOOL', type=_str_to_bool)
